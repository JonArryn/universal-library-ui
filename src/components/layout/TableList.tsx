...
import { IListColumns, IListPagination } from '../../hooks/useList.ts';
                                        ...
                                        (
                                            ...
                                            <tr key={`row-${rowIndex}`}>
                                                {Object.entries(row).map(
                                                    ([key, value]) => (
                                                        <td
                                                            className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 dark:text-slate-50"
                                                            hidden={
                                                                !tableHeaders[
                                                                    key
                                                                ].visible
